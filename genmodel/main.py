...
if __name__ == '__main__':
    ...
    arg(parser, 'learning_rate', type=float, default=1e-3, help='-1 to use model default')
    ...
    arg(parser, 'z_size', type=int, default=32, help='latent dims per layer')
    arg(parser, 'kl_weight', type=float, default=1.0, help='KL term weight (beta VAE)')
    arg(parser, 'sampled_kl', type=bool, default=False, help='Use sampled KL estimation')
    arg(parser, 'q_dist', type=str, default='gaussian', help='Choices: gaussian, di')
    arg(parser, 'p_dist', type=str, default='gaussian', help='Choices: gaussian, di')
